use piranhas_bot_v2::board::{Move, MoveList, Position, Undo, ONE, TWO};
use piranhas_bot_v2::evaluate::terminal_swarm_score;
...
struct GameResult {
    ...
    blue_swarm: i32,
    turns: u16,
    red_connected: Option<u16>,
    blue_connected: Option<u16>,
    red_time_ms: f64,
    blue_time_ms: f64,
}
...
fn play_one_game(red_time_ms: u64, blue_time_ms: u64, verbose: bool) -> GameResult {
    ...
    GameResult {
        ...
        blue_swarm,
        turns: pos.turn,
        red_connected: pos.connected_since[0],
        blue_connected: pos.connected_since[1],
